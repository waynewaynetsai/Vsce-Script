...
export interface LibraryApi {
  ...
  interactive: {
    ...
    input: ( prompt: string, options?: vscode.InputBoxOptions) => Promise<string>;
    dropdown: (title: string, items: string[], options?: vscode.QuickPickOptions) => Promise<string | undefined>;
